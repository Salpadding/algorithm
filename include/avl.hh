...
public:
  ...
  avl_tree_node(int val)
      : val(val), depth(1), left_child(NULL), right_child(NULL), parent(NULL) {}
...
int avl_tree_node::find_depth() {
  int left_depth = this->left_child ? this->left_child->find_depth() : 0;
  int right_depth = this->right_child ? this->right_child->find_depth() : 0;
